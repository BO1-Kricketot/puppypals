...
const Home = ({ navigation }) => {
  ...
  useEffect(() => {
    Promise.all([
      applyFilter
        ? axios.get(
            `${API_URL}/api/dogs/6408d66fec97eb3b6680291a?${filterParams}`,
          )
        ...
        <SafeAreaView style={styles.container}>
          <View style={styles.userInfoContainer}>
            ...
            <View
              ...
              <Pressable style={{backgroundColor: '#A594F9', borderWidth: 1, borderRadius: 10, borderColor: '#FAFAFA', padding: 10}}
               onPress={() => {
